                ...
                <div className="space-py-4">
                   ...
                   <div className="rounded-lg bg-muted p-4 space-y-2">
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                        ...
                        <li> <code className="bg-background px-1 py-0.5 rounded">{"Stripe.currency"}</code> - Payment currency </li>
                        ...
                        <li> <code className="bg-background px-1 py-0.5 rounded">{"Stripe.eventType"}</code> - Event type (e.g paymenr_intent.succeeded) </li>
                    </ul>
